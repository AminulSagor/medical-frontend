...
import TermsOfServiceHero from "./_components/terms-of-service-hero";
import {
    TERMS_OF_SERVICE_DATA,
    TermsOfServiceSection,
    TermsOfServiceTOCItem,
} from "@/app/public/data/terms-of-service.data";
...
export default function TermsOfServicePage() {
    const { toc, helpCard, sections } = TERMS_OF_SERVICE_DATA;
    const [activeId, setActiveId] = React.useState<string>(
        toc[0]?.id ?? "introduction",
    );
...
function SectionBlock({ section }: { section: TermsOfServiceSection }) {
    return (
        <section id={section.id} className="scroll-mt-24">
            ...
            {section.callout ? (
                <div className="mt-5">
                    <CalloutBox title={section.callout.title} text={section.callout.text} />
                </div>
            ) : null}
