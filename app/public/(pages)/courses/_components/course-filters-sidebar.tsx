...
export default function CourseFiltersSidebar({
  ...
  return (
    <aside className="self-start rounded-3xl border border-light-slate/15 bg-white p-6 shadow-sm lg:sticky lg:top-24 lg:h-fit lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto">
