  ...
  return (
    <ModalShell onClose={onClose}>
      <div className="relative w-full max-w-[520px] rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
        ...
        <h3 className="mt-4 text-center text-base font-extrabold text-slate-900">Draft Saved Successfully</h3>
        ...
        <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-4">
          ...
          <div className="mt-3 flex items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-wide text-slate-400">Last Saved</p>
        ...
        <p className="mt-4 text-center text-xs leading-5 text-slate-500">
          Your progress has been safely stored. This article will remain as a draft and will not be visible to the
