...
import GeneralDataParentTabs from "@/app/(admin)/newsletters/general-newsletter/_components/general-data-parent-tabs";
import GeneralDataChildTabs from "@/app/(admin)/newsletters/general-newsletter/_components/general-data-child-tabs";
import GeneralDataToolbar from "@/app/(admin)/newsletters/general-newsletter/_components/general-data-toolbar";
import GeneralQueueTable from "@/app/(admin)/newsletters/general-newsletter/_components/general-queue-table";
import GeneralDraftsTable from "@/app/(admin)/newsletters/general-newsletter/_components/general-drafts-table";
import GeneralHistoryTable from "@/app/(admin)/newsletters/general-newsletter/_components/general-history-table";
...
} from "@/app/(admin)/newsletters/general-newsletter/data/general-broadcast-queue.data";
import GeneralStatOverview from "@/app/(admin)/newsletters/general-newsletter/_components/general-stats-overview";
import {
  draftBroadcasts,
  draftsPagination,
} from "@/app/(admin)/newsletters/general-newsletter/data/general-broadcast-drafts.data";
import {
  historyBroadcasts,
  historyPagination,
} from "@/app/(admin)/newsletters/general-newsletter/data/general-broadcast-history.data";
