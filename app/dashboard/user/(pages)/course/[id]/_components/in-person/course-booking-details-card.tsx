...
export default function CourseBookingDetailsCard({
  ...
  <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1px_1fr]">
        <div className="flex items-center gap-4 p-6 lg:p-7">
          ...
          <div>
            ...
            <div className="mt-1 text-[18px] font-extrabold leading-tight text-slate-900">
              {status.value}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 p-6 lg:p-7 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-start">
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 text-[18px] font-extrabold leading-tight text-sky-500">
                Total Fee:
              </div>
              <div className="mt-1 text-[18px] font-extrabold leading-tight text-sky-500">
                {payment.amount}
              ...
              <div className="mt-3 flex w-full items-start gap-2 text-[11px] leading-snug text-slate-400">
                <span className="mt-[2px] inline-grid h-4 w-4 shrink-0 place-items-center rounded-full border border-slate-300 text-[10px] text-slate-400">
                  i
                </span>
          ...
          <div className="justify-self-start sm:justify-self-end">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-[12px] font-semibold text-slate-500 hover:bg-slate-50"
            >
    ...
    <RefundSubmittedModalClient
      ...
      confirmationText={
        submittedData
          ? `${submittedData.requestedMemberCount} member(s) selected for refund.`
          : undefined
      }
