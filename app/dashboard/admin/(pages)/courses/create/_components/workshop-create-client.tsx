...
export default function WorkshopCreateClient() {
  ...
  const FACILITY_OPTIONS: Array<ThemeDropdownOption<FacilityLocation>> =
    useMemo(
      () =>
        facilities.map((f) => ({
          value: f.id,
  ...
  useEffect(() => {
    function handleClickOutside(e: MouseEvent) {
      if (
        ...
        !facultySearchRef.current.contains(e.target as Node)
      ) {
        setFacultyDropdownOpen(false);
      }
    }
                      ...
                      <div className="absolute left-0 right-0 top-full z-20 mt-1 max-h-[240px] overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-lg">
                        {facultyResults.length === 0 ? (
                          ...
                          facultyResults
                            .filter(
                              (r) =>
                                !selectedFaculty.some((s) => s.id === r.id),
                            )
                            .map((faculty) => (
                              <button
                                key={faculty.id}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Add a new instructor or expert to the system
                    </p>
                  </div>
                </div>
                <ArrowLeft
                  size={16}
                  className="rotate-180 text-slate-400 group-hover:text-[var(--primary)] transition"
                />
              </Link>
            </div>
          </Card>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <TextInput
                    ...
                    onChange={(e) =>
                      setStandardRate(Number(e.target.value || 0))
                    }
                    className="pl-8"
                    inputMode="decimal"
                  />
                ...
                <div className="mt-3 space-y-3">
                  <div>
                    ...
                    <TextInput
                      ...
                      onChange={(e) =>
                        setMinAttendees(Number(e.target.value || 0))
                      }
                      inputMode="numeric"
                    />
                    <p className="mt-1 text-xs text-slate-400">
                      Set the minimum number of attendees required to trigger
                      the group rate.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <TextInput
                        ...
                        onChange={(e) =>
                          setGroupRate(Number(e.target.value || 0))
                        }
                        className="pl-8"
                        inputMode="decimal"
                      />
