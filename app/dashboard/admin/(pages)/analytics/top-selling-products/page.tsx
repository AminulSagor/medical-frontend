...
export default async function TopSellingProductsViewAllPage({
    searchParams,
}: {
    ...
    const limit = toPositiveInt(typeof params.limit === "string" ? params.limit : undefined, 10);
    const category = typeof params.category === "string" ? params.category : undefined;
    const startDate = typeof params.startDate === "string" ? params.startDate : defaults.startDate;
    const endDate = typeof params.endDate === "string" ? params.endDate : defaults.endDate;
    ...
    const metrics =
        metricsResult.status === "fulfilled"
            ? metricsResult.value
            : { totalProductsSold: 0, avgOrderValue: 0, returnRate: 0 };
    const table =
