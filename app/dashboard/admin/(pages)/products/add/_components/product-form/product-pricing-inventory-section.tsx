...
export default function ProductPricingInventorySection({
  ...
  onStockQtyChange: (value: number) => void;
}) {
  return (
          ...
          <div>
            ...
            <div className="flex h-10 items-center overflow-hidden rounded-md border border-slate-200 bg-white">
              ...
              <Input
                ...
                onChange={(value) =>
                  onStockQtyChange(Math.max(0, Number(value || 0)))
                }
                type="number"
                className="h-full flex-1 rounded-none border-0 text-center text-sm font-semibold text-slate-900 focus:ring-0"
              />
