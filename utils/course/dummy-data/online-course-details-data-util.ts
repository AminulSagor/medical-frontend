...
export function getOnlineDetailsSeed(_courseId: string): OnlineDetailsViewProps {
    return {
        hero: {
        ...
        summary: {
            ...
            description: "Comprehensive 3-day virtual intensive for complex airway management scenarios.",
        ...
        about: {
            ...
            highlights: [
                ...
                { iconKey: "check", text: "Accredited for 12 AMA PRA Category 1 Credits" },
